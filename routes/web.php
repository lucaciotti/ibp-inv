...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/inventory/exportxls_warehouse_simple', [App\Http\Controllers\InventoryController::class, 'exportXlsWarehouseSimple'])->name('exportxls_warehouse_simple');
